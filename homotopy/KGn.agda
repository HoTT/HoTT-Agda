...
module KGnImplicit {i} (A : Type i) (cA : is-connected ⟨0⟩ A)
  ...
  module BelowDiagonal where
    ...
    π-below : (k n : ℕ) → ⦃ pk : k ≠ 0 ⦄ → (k < n)
      → π k ⦃ pk ⦄ (Ptd-KG n) == LiftUnit-Group
