...
module homotopy.Pi2HSuspHomomorphismCoh {i} {X : Ptd i} {{_ : has-level 1 (de⊙ X)}}
  ...
  module InnerDiagramCommutes (y : A) where
    ...
    cd₆ =
      ...
      where
        e₁₋₁₄' : c₁ == c₁₄
        e₁₋₁₄' = ap merid $
                  ! (H-X-assoc e y e) ∙ μ.unit-r (μ e y)
        step₁ : e₁₋₁₄ == e₁₋₁₄'
        step₁ = ap (ap merid) step₁'
          where
          step₁' : ap (μ e) (μ.unit-r y) == ! (H-X-assoc e y e) ∙ μ.unit-r (μ e y)
          step₁' = pre-rotate-in (ap (μ e) (μ.unit-r y)) (H-X-assoc e y e) (μ.unit-r (μ e y)) $
                    ! (coh-assoc-unit-r e y)
        step₂ : e₁₋₁₄' == e₁₋₁₃ ∙ e₁₃₋₁₄
        step₂ = ap-∙ merid (! (H-X-assoc e y e)) (μ.unit-r (μ e y))

    diagram-commutes : e₁₋₂ ∙ e₂₋₁₆ ∙ e₁₆₋₈ == e₁₋₁₃ ∙ e₁₃₋₁₂ ∙ e₁₂₋₉ ∙ e₉₋₈
    diagram-commutes =
      (e₁₋₂ ◃∙ e₂₋₁₆ ◃∙ e₁₆₋₈ ◃∎)
        =↯=⟨ 1 & 1 & (e₂₋₁₅ ◃∙ e₁₅₋₁₆ ◃∎) & cd₁ ⟩
      (e₁₋₂ ◃∙ e₂₋₁₅ ◃∙ e₁₅₋₁₆ ◃∙ e₁₆₋₈ ◃∎)
  ...
  module OuterDiagram (x y z : A) where
    ...
    e₁₋₁₃ : c₁ == c₁₃
    e₁₋₁₃ = ap (λ s → [ merid s ]₁) (! (H-X-assoc x y z))
  ...
  module OuterDiagramCommutes (y : A) where

    private
      module ID = InnerDiagramCommutes y
    open OuterDiagram e y e
  ...
  private
    homomorphism-coh' : ∀ y x z → OuterDiagram.e₁₋₈ x y z
                                  == OuterDiagram.e₁₋₈' x y z
    homomorphism-coh' y =
      prop-over-connected {A = A} {a = e} {{is-0-connected}}
                          (λ x → (∀ z → Q x z) , Π-level (Q-is-prop x)) $
      prop-over-connected {A = A} {a = e} {{is-0-connected}}
                          (λ z → Q e z , Q-is-prop e z) $
      OuterDiagramCommutes.diagram-commutes y
      where
      Q : A → A → Type i
      Q x z = OuterDiagram.e₁₋₈ x y z
              == OuterDiagram.e₁₋₈' x y z
      Q-is-prop : ∀ x z → is-prop (Q x z)
      Q-is-prop x z = has-level-apply (has-level-apply (Trunc-level {n = 1}) _ _) _ _

  homomorphism-coh : ∀ x y z → OuterDiagram.e₁₋₈ x y z
                                == OuterDiagram.e₁₋₈' x y z
  homomorphism-coh x y z = homomorphism-coh' y x z
