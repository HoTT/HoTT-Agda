  ...
  module _ {a₀} {b₀} (q₀₀ : Q a₀ b₀) where
    ...
    abstract
      ...
      code-coh-lemma q₀₁ =
        ...
        Coh.to' q₀₀ q₀₁ (bmglue q₀₁) (q₀₀ , p₁p₁⁻¹p₂=p₂ (bmglue q₀₀) (bmglue q₀₁))
          =⟨ ap (Coh.To.ext q₀₀ (_ , q₀₀) (_ , q₀₁) (bmglue q₀₁)) (path-lemma (bmglue q₀₀) (bmglue q₀₁)) ⟩
        Coh.To.ext q₀₀ (_ , q₀₀) (_ , q₀₁) (bmglue q₀₁) (! (Coh.path-lemma₂ q₀₁ q₀₀))
          =⟨ Coh.To.β-r q₀₀ (_ , q₀₁) (bmglue q₀₁) (! (Coh.path-lemma₂ q₀₁ q₀₀)) ⟩
        [ q₀₁ , Coh.path-lemma₂ q₀₁ q₀₀ ∙' ! (Coh.path-lemma₂ q₀₁ q₀₀) ]
          =⟨ ap (λ p → [ q₀₁ , p ]) (!-inv'-r (Coh.path-lemma₂ q₀₁ q₀₀)) ⟩
        [ q₀₁ , idp ]
          =∎
        where
          ...
          p₁p₁⁻¹p₂=p₂ : ∀ {l} {D : Type l} {d₁ d₂ d₃ : D} (p₁ : d₁ == d₂) (p₂ : d₁ == d₃)
            → p₁ ∙' ! p₁ ∙' p₂ == p₂
          p₁p₁⁻¹p₂=p₂ p₁ p₂ = ! (∙'-assoc p₁ (! p₁) p₂) ∙ ap (_∙' p₂) (!-inv'-r p₁) ∙' ∙'-unit-l p₂

          -- the relation of this path and the one in CoherenceData.
          path-lemma : ∀ {l} {D : Type l} {d₁ d₂ d₃ : D} (p₁ : d₁ == d₂) (p₂ : d₁ == d₃)
            → p₁p₁⁻¹p₂=p₂ p₁ p₂ == ! (Coh.p₁=p₂p₂⁻¹p₁ p₂ p₁)
