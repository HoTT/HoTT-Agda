...
module cw.cohomology.FirstFinCoboundaryCommSquare (OT : OrdinaryTheory lzero)
  (⊙fin-skel : ⊙FinSkeleton 1) where

open OrdinaryTheory OT
open import cw.cohomology.TipAndAugment OT ⊙⦉ ⊙fcw-init ⊙fin-skel ⦊
open import cw.cohomology.TipCoboundary OT ⊙⦉ ⊙fin-skel ⦊
open import cw.cohomology.WedgeOfCells OT ⊙⦉ ⊙fin-skel ⦊
open import cw.cohomology.RephraseDualizedFirstFinBoundary OT ⊙fin-skel
open import cw.cohomology.RephraseFirstFinCoboundary OT ⊙fin-skel
