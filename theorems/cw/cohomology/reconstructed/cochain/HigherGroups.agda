...
module cw.cohomology.reconstructed.cochain.HigherGroups {i : ULevel} (OT : OrdinaryTheory i) where
  ...
  import cw.cohomology.reconstructed.HigherGroups OT as HCG
  import cw.cohomology.reconstructed.HigherGroupsOnDiag OT as HCGD
