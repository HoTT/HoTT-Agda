...
module cw.cohomology.HigherFinCoboundaryCommSquare (OT : OrdinaryTheory lzero)
  {n} (⊙fin-skel : ⊙FinSkeleton (S (S n))) where

open OrdinaryTheory OT
open import cw.cohomology.HigherCoboundary OT ⊙⦉ ⊙fin-skel ⦊
open import cw.cohomology.WedgeOfCells OT
open import cw.cohomology.RephraseDualizedHigherFinBoundary OT ⊙fin-skel
open import cw.cohomology.RephraseHigherFinCoboundary OT ⊙fin-skel
